  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CategoryService>(
      builder: (context, provider, child) {
        return provider.categoryDataModel.categories != null
            ? provider.categoryDataModel.categories != 'error'
                ? Container(
                    alignment: Alignment.center,
                    child: ListView.builder(
                      itemCount: provider.isExpanded
                          ? (provider.categoryDataModel.categories?.length ?? 0)
                      ...
                      itemBuilder: (context, indexParent) {
                        final category =
                            provider.categoryDataModel.categories?[indexParent];
